...
class MyParcel extends Module
{
    ...
    protected function addCarrier($name, $key = self::POSTNL_DEFAULT_CARRIER)
    {
        ...
        if ($carrier->add()) {
            @copy(dirname(__FILE__).'/views/img/postnl-thumb.jpg', _PS_SHIP_IMG_DIR_.'/'.(int) $carrier->id.'.jpg');
...
//        }
    ...
    public function hookDisplayCarrierList($params)
    {
        ...
        if (Tools::strtoupper($country->iso_code) !== 'NL') {
            return null;
        }
        ...
        if (Tools::strtoupper($currency->iso_code) === 'EUR' && Validate::isLoadedObject($mcds) && ($mcds->delivery || $mcds->pickup)) {
    ...
    public function hookAdminOrder($params)
    {
        ...
        // TODO: ensure that deliveryOption is valid JSON
        $this->context->smarty->assign(
            array(
    ...
    public function hookActionValidateOrder($params)
    {
        ...
        $deliveryOption = MyParcelDeliveryOption::getByCart($cart->id);
    ...
    public function getOrderShippingCost($params, $shippingCost)
    {
        ...
        $deliveryOption = MyParcelDeliveryOption::getByCart($cart->id, false);
    ...
    public function calcPackageShippingCost($cart, $idCarrier, $useTax = true, $defaultCountry = null, $productList = null, $idZone = null, $recursion = true)
    {
        ...
        $mdo = MyParcelDeliveryOption::getByCart($cart->id);
