...
<ul>
	<li><strong>{ldelim}order.id{rdelim}</strong> - {l s='Order ID' mod='myparcel'}</li>
	<li><strong>{ldelim}order.reference{rdelim}</strong> - {l s='Order reference' mod='myparcel'}</li>
</ul>
