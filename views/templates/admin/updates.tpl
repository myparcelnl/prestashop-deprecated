...
<div class="panel">
	...
	<a class="btn btn-default" href="{$module_url|escape:'htmlall':'UTF-8'}&myparcelCheckForUpdates=1"><i class="icon icon-search"></i> {l s='Check for updates' mod='myparcel'}</a>
</div>
